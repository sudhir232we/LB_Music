...
OWNER_ID = int(getenv("OWNER_ID", "1002173091918"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/JOURNEYTOFRIENDSHIP")
SUPPORT_CHAT = getenv("SUPPORT_GROUP", "https://t.me/JOURNEYTOFRIENDSHIP")
