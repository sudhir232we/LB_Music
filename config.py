...
API_ID = int(getenv("API_ID", "29771787"))
API_HASH = getenv("API_HASH", "ada9503721914aae513dabc6ddb2d73c")
...
OWNER_ID = int(getenv("OWNER_ID", "7251166708"))
...
STRING3 = getenv("STRING_SESSION", None)
STRING4 = getenv("STRING_SESSION2", None)
